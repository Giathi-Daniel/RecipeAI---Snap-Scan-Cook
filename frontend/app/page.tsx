    ...
    <div className="mx-auto max-w-6xl px-6 pb-20 pt-12">
      <section className="border-b border-sand pb-16">
        <div className="max-w-3xl">
          <h1 className="font-display text-6xl leading-tight text-ink">
          ...
          <div className="mt-10 flex flex-wrap gap-4">
            <Link
              href="/upload"
              className="border border-ink bg-ink px-8 py-4 text-sm font-semibold uppercase tracking-wider text-canvas transition hover:bg-ink/90"
            >
              Upload Recipe
            </Link>
            <Link
              href="/dashboard"
              className="border border-sand bg-white px-8 py-4 text-sm font-semibold uppercase tracking-wider text-ink transition hover:border-ink"
            >
              View Dashboard
            </Link>
          </div>
      ...
      <section className="pt-16">
        <h2 className="text-sm font-semibold uppercase tracking-[0.2em] text-ink/50">Features</h2>
        <div className="mt-8 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {features.map((feature) => (
            <div key={feature.title} className="border border-sand bg-white p-6">
      ...
      <section className="mt-16 border border-sand bg-white p-10">
        <div className="max-w-2xl">
          <h2 className="font-display text-3xl text-ink">Built with modern tools</h2>
          ...
          <div className="mt-8 flex flex-wrap gap-4">
            <a
              ...
              className="border border-sand px-6 py-3 text-sm font-semibold uppercase tracking-wider text-ink transition hover:border-ink"
            >
              View on GitHub
            </a>
            <a
